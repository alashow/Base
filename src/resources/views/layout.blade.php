...
<head>
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="{{ asset('vendor/backpack/font-awesome/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/backpack/ionicons/css/ionicons.min.css') }}">
